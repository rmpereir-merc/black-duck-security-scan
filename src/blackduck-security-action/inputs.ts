...
export const BLACKDUCKSCA_FIX_PR_ENABLED = getInput(constants.BLACKDUCKSCA_FIX_PR_ENABLED_KEY)?.trim() || getInput(constants.BLACKDUCK_FIXPR_ENABLED_KEY)?.trim() || ''
...
export const BLACKDUCKSCA_FIX_PR_MAX_COUNT = getInput(constants.BLACKDUCKSCA_FIX_PR_MAX_COUNT_KEY)?.trim() || getInput(constants.BLACKDUCK_FIXPR_MAXCOUNT_KEY)?.trim() || ''
export const BLACKDUCKSCA_FIX_PR_CREATE_SINGLE_PR = getInput(constants.BLACKDUCKSCA_FIX_PR_CREATE_SINGLE_PR_KEY)?.trim() || getInput(constants.BLACKDUCK_FIXPR_CREATE_SINGLE_PR_KEY)?.trim() || ''
export const BLACKDUCKSCA_FIX_PR_FILTER_SEVERITIES = getInput(constants.BLACKDUCKSCA_FIX_PR_FILTER_SEVERITIES_KEY)?.trim() || getInput(constants.BLACKDUCK_FIXPR_FILTER_SEVERITIES_KEY)?.trim() || ''
export const BLACKDUCKSCA_FIX_PR_UPGRADE_GUIDANCE = getInput(constants.BLACKDUCKSCA_FIX_PR_UPGRADE_GUIDANCE_KEY)?.trim() || getInput(constants.BLACKDUCK_FIXPR_USE_UPGRADE_GUIDANCE_KEY)?.trim() || ''
...
export const BLACKDUCKSCA_POLICY_BADGES_CREATE = getInput(constants.BLACKDUCKSCA_POLICY_BADGES_CREATE_KEY)?.trim() === 'true' || false
export const BLACKDUCK_POLICY_BADGES_MAX_COUNT = getInput(constants.BLACKDUCKSCA_POLICY_BADGES_MAX_COUNT_KEY)?.trim() || ''
